...
export class Matrix4 {
    ...
    clone() { return new Matrix4().fromArray(this.toArray()); }
    determinant() {
    ...
    invertible() { return this.determinant() !== 0; }
    /**
    ...
    _det2(m00, m01, m10, m11) {
        return m00 * m11 - m01 * m10;
    }
    _det3(m00, m01, m02, m10, m11, m12, m20, m21, m22) {
        const self = this;
